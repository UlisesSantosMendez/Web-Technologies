...
<body>
    ...
    <img class="logo"
        ...
        <ul class="nav">
                ...
                <li><a href="/project/usuario-alumno-materia.php?id=<?php echo $usuario?>" style="background-color: blue;">Material</a></li>
    ...
    <section name="area-desplegar">
        ...
        <div style="margin: 0 auto; width:100%; height:400px;">
            <object type="text/html" data="https://libros.conaliteg.gob.mx/2021/P1MAA.htm"
