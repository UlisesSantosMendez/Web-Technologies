...
<head>
    ...
    <title>Usuario alumno | Bloque 2</title>
...
<body>
        ...
        <ul class="nav">
                <li><a href="/project/usuario-alumno.php?id=<?php echo $usuario?>" >Bloque</a>
                    <ul>
                        ...
                        <li><a href="/project/usuario-alumno-bloque_dos.php?id=<?php echo $usuario?>" style="background-color: blue;">Bloque 2</a></li>
    ...
    <section name="area-desplegar">
        <h2>Consulta de temas bloque 2</h2>
