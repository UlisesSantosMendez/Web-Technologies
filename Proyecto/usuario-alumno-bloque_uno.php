...
<head>
    ...
    <title>Usuario alumno | Bloque 1</title>
...
<body>
    ...
    <img class="logo"
        ...
        <ul class="nav">
                <li><a href="/project/usuario-alumno.php?id=<?php echo $usuario?>" >Bloque</a>
                    <ul>
                        <li><a href="/project/usuario-alumno-bloque_uno.php?id=<?php echo $usuario?>" style="background-color: blue;">Bloque 1</a></li>
    ...
    <section name="area-desplegar">
        <h2>Consulta de temas bloque 1</h2>
